...
import { isArray, isDate, isPureObject, isURLSearchParams } from "./utils"
...
export function buildURL(
  ...
  if (paramsSerializer) { // 用户自定义参数处理
    serializedParams = paramsSerializer(params)
  } else if (isURLSearchParams(params)) { // params 为 URLSearchParams 对象
